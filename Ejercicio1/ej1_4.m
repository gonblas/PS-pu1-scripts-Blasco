...
color_S1 = {'b'}; % Azul
plot_signal(data_S1, 1, 1, title_S1, xlabel_S1, ylabel_S1, plot_type_S1, filename_S1, color_S1);
...
color_S2 = {'r'}; % Rojo
plot_signal(data_S2, 1, 1, title_S2, xlabel_S2, ylabel_S2, plot_type_S2, filename_S2, color_S2);
...
color_S3 = {'g'}; % Verde
plot_signal(data_S3, 1, 1, title_S3, xlabel_S3, ylabel_S3, plot_type_S3, filename_S3, color_S3);
